                        ...
                        <div class="mm-motivz-jobdetail-content details-tabswrapper">
                            <div class="motivz-details-tabs">
                                <ul>
                                    ...
                                    <li class="active active-page"><span class="fa fa-money"></span><br>
                            ...
                            <form action="#" name="profile_form" id="form_profile" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12"><br>
                                        <a href="{{route('job.review')}}" class="pull-right form-submit">
                                            SUBMIT FOR REVIEW
                                        </a>
                                        <a href="{{route('job.qualification')}}" class="form-submit">
                                            Back
                                        </a>
                                    </div>
                                </div>
