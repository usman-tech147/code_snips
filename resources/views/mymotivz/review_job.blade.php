                    ...
                    <div class="col-md-12">
                        <div class="jobs-details">
                            ...
                            <section>
                                ...
                                <a href="{{route('job.details')}}" class="simple-btn">Edit Job Position</a>
                            </section>
                        ...
                        <div class="jobs-details">
                            ...
                            <section>
                                ...
                                <a href="{{route('job.qualification')}}" class="simple-btn">Edit Job Qualifications</a>
                            </section>
                            <div class="clearfix"></div>
                        </div>
                        <div class="jobs-details">
                            ...
                            <section>
                                ...
                                <a href="{{route('job.benefits')}}" class="simple-btn">Edit Pay & Benefits</a>
                            </section>
                            <div class="clearfix"></div>
                        </div>
                    </div>
